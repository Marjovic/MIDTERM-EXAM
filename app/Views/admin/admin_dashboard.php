...
<head>
    ...
    <title><?= $title ?? 'Admin Dashboard - MGOD LMS' ?></title>
            ...
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-body text-center">
                        <i class="fas fa-user-shield text-dark mb-3" style="font-size: 4rem;"></i>
                        <h1 class="card-title text-dark">Welcome, Admin!</h1>
                        <p class="card-text lead">Hello, <?= esc($user['name']) ?>! Welcome to your administrative dashboard.</p>
